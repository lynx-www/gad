...
<nav class="navbar navbar-inverse navbar-static-top fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a class="dropdown-toggle" data-toggle="dropdown" href="?id=device">Оборудование</a>
      <ul class="dropdown-menu">
          <li><a href="?id=device&sub=model">Модели</a></li>
          <li><a href="?id=device&sub=manufacturer">Производитель</a></li>
